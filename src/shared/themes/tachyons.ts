...
export const tachyonsStyles = StyleSheet.create({
  flex: { flex: 1 },
  flex0: { flex: 0 },
  flex1: { flex: 0.1 },
  flex2: { flex: 0.2 },
  ...
  pv4: { paddingVertical: 32 },
  pv5: { paddingVertical: 64 },
  pv6: { paddingVertical: 128 },
  pv7: { paddingVertical: 256 },
  ph0: { paddingHorizontal: 0 },
  ph1: { paddingHorizontal: 4 },
  ph2: { paddingHorizontal: 8 },
  ph3: { paddingHorizontal: 16 },
  ph4: { paddingHorizontal: 32 },
  ph5: { paddingHorizontal: 64 },
  ph6: { paddingHorizontal: 128 },
  ph7: { paddingHorizontal: 256 },
  ma0: { margin: 0 },
  ma1: { margin: 4 },
  ma2: { margin: 8 },
  ma3: { margin: 16 },
  ...
  mv4: { marginVertical: 32 },
  mv5: { marginVertical: 64 },
  mv6: { marginVertical: 128 },
  mv7: { marginVertical: 256 },
  mh0: { marginHorizontal: 0 },
  mh1: { marginHorizontal: 4 },
  mh2: { marginHorizontal: 8 },
  mh3: { marginHorizontal: 16 },
  mh4: { marginHorizontal: 32 },
  mh5: { marginHorizontal: 64 },
  mh6: { marginHorizontal: 128 },
  mh7: { marginHorizontal: 256 },
  na1: { margin: -4 },
  na2: { margin: -8 },
  na3: { margin: -16 },
  na4: { margin: -32 },
